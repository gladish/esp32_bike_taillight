 ...
 *
 * On success, writes led_count results into out_leds[] and returns true.
 * On error (Lua runtime error, or an out-of-range strip.set() index),
 * out_leds[] is left completely untouched -- the frame commit is
